export const TEXT = {
  ja: {
    ...
    updating: '更新中...',
    updatingCrossTabulation: '横断集計を更新中...',
    generatingAuditForecast: '監査予報を生成中...',
    crossTabulationUpdateFailed: '横断集計の更新に失敗しました',
    generatingTaxAuthorityPerspective: '税務署視点の総括を生成中...',
    forecastDataSaveFailed: '予報データの保存に失敗しました',
    lastAccessDateUpdateFailed: '最終アクセス日の更新に失敗しました',
    loadingSavedForecast: '保存された予報を読み込み中...',
    loadingAuditForecast: '監査予報を読み込み中...',
    updatingAuditForecast: '監査予報を更新中...',
    update: '更新',
    ...
    immediateActionsRequired: '対応推奨アクション',
    aiGeneratedGuidance: '参考アドバイス（AI-generated guidance）',
    aiGuidanceUnavailable: 'AIのアドバイスを取得できませんでした。',
    aiRateLimitReached: 'AIリクエスト上限に達したため、しばらくしてから再度お試しください。',
  ...
  en: {
    ...
    updating: 'Updating...',
    updatingCrossTabulation: 'Updating cross tabulation...',
    generatingAuditForecast: 'Generating audit forecast...',
    crossTabulationUpdateFailed: 'Failed to update cross tabulation...',
    generatingTaxAuthorityPerspective: 'Generating tax authority perspective summary...',
    forecastDataSaveFailed: 'Failed to save forecast data...',
    lastAccessDateUpdateFailed: 'Failed to update last access date...',
    loadingSavedForecast: 'Loading saved forecast...',
    loadingAuditForecast: 'Loading audit forecast...',
    updatingAuditForecast: 'Updating audit forecast...',
    update: 'Update',
    ...
    immediateActionsRequired: 'Immediate Actions Recommended',
    aiGeneratedGuidance: 'Suggested audit preparation steps (AI-generated guidance)',
    aiGuidanceUnavailable: 'AI guidance is not available.',
    aiRateLimitReached: 'AI rate limit reached. Please try again later.',
