export const TEXT = {
  ja: {
    ...
    taxAuditConcernsGeneric: '{accountName}が総支出の{ratio}%を占める構造は、「実態のある事業活動が本当に存在しているか」という観点で強く疑義を持たれやすい財務パターンです。',
    justificationCasesGeneric: 'ただし、正当化されやすいケース：',
    justificationPoint1: '事業規模・業種に合った合理的な支出額であること',
    justificationPoint2: '売上・事業活動との明確な因果関係が説明できること',
    justificationPoint3: '市場相場・業界平均と比較して妥当な水準であること',
    justificationNote: '→ 事業内容との整合性説明と裏付け資料が重要です',
    riskBasisTitle: 'リスクの根拠（数値・ルール）',
    dataInsufficientNoteTitle: '⚠️ 比較データ不足に関する注意',
    action1: '{accountName}の契約書・領収書・使用実態資料を準備',
    action2: '売上と事業活動との関係性を説明できる資料を作成',
    action3: '他の経費項目が極端に少ない理由を整理',
    action4: '前年比 +{growthRate}% となった理由を言語化',
    denialRiskNote: '※ これらが説明できない場合、否認リスクが高まります',
